...
public static class Uhf {
  public const string Dll = "C:\\Cursor\\IN53xx_workflow_DLL_x64\\build-x64\\Release\\UhfWrapper.dll";
...
Set-Location "C:\\Cursor\\IN53xx_workflow_DLL_x64\\build-x64\\Release"
